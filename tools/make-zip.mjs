 ...
 *
 * Only the site itself goes in: index.html, css/, assets/ and the README.
...
const INCLUDE = ["index.html", "README.md", "css", "assets"];
const OUT = join(ROOT, "task-one-submission.zip");
const PREFIX = "task-one/";
